...
namespace Stoicode.UniLib.Ntp
{
    ...
    public class LocalPlayer : MonoBehaviour
    {
        ...
        private TickExecutor sendMoveExecutor;
        private List<Vector3> positionsCache;
        ...
        private void SendMove()
        {
            ...
            NetCoreClient.Instance.Move(positionsCache);
            positionsCache.Clear();
        }

        private void Target()
        {
            //positionsCache.Add(transform.position);
            NetCoreClient.Instance.MoveSimple(transform.position);
        }
